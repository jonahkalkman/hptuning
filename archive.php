...
<section class="c-archive" style="margin-top: 0px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 u-horizontal-align--center">
                <h2><?php the_field('titel_collectie', 'option'); ?></h2>
                <!-- <?php 
                    $categories = get_categories('cars');
                    foreach ($categories as $category) {
                        if($category->name !== 'Geen categorie') {
                            $category_link = get_category_link($category);
                            echo '<a class="archive__link" href='.$category_link.'>'.$category->name.'</a>' ;
                        }
                    }
                ?> -->
            </div>
